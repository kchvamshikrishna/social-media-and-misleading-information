...
ROOT_URLCONF = 'social_mediaand_misleading_information.urls'
...
WSGI_APPLICATION = 'social_mediaand_misleading_information.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'social_mediaand_misleading_information',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
